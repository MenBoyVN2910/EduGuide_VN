  ...
  return (
    <div className="relative mx-auto flex w-full max-w-[800px] flex-col gap-2 px-4 md:px-8">
      <div className="group relative flex w-full items-end overflow-hidden rounded-[26px] bg-muted border border-border transition-all duration-300">
        <div className="flex h-[52px] shrink-0 items-center justify-center pl-2">
          <Button
            size="icon"
            variant="ghost"
        ...
        <textarea
          ...
          disabled={isLoading}
        />
        <div className="absolute right-0 bottom-0 flex h-[52px] shrink-0 items-center justify-center pr-2 pointer-events-none">
          <div
            className={`transition-all duration-200 ${input.trim() ? "opacity-100 pointer-events-auto scale-100" : "opacity-0 scale-95"}`}
          >
            <Button
              size="icon"
            ...
            >
              {isLoading ? (
                ...
                <svg
                  ...
                  className="icon-md h-5 w-5"
                  aria-hidden="true"
                >
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M11.2929 3.29289C11.6834 2.90237 12.3166 2.90237 12.7071 3.29289L19.7071 10.2929C20.0976 10.6834 20.0976 11.3166 19.7071 11.7071C19.3166 12.0976 18.6834 12.0976 18.2929 11.7071L13 6.41421V20C13 20.5523 12.5523 21 12 21C11.4477 21 11 20.5523 11 20V6.41421L5.70711 11.7071C5.31658 12.0976 4.68342 12.0976 4.29289 11.7071C3.90237 11.3166 3.90237 10.6834 4.29289 10.2929L11.2929 3.29289Z"
                    fill="currentColor"
                  />
                </svg>
              )}
