  ...
  const SAMPLES = [
    {
      ...
      title: t("chat.sample1Title"),
      description: t("chat.sample1Desc"),
      text: t("chat.sample1Text")
    },
    {
      icon: <Search className="h-4 w-4 text-orange-500" />,
      title: t("chat.sample2Title"),
      description: t("chat.sample2Desc"),
      text: t("chat.sample2Text")
    },
    {
      icon: <Link2 className="h-4 w-4 text-purple-500" />,
      title: t("chat.sample3Title"),
      description: t("chat.sample3Desc"),
      text: t("chat.sample3Text")
    },
    {
      icon: <GraduationCap className="h-4 w-4 text-emerald-500" />,
      title: t("chat.sample4Title"),
      description: t("chat.sample4Desc"),
